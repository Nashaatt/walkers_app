...
class _NewTripScreenState extends State<NewTripScreen>
{
  ...
  saveAssignedDriverDetailsToUserRideRequest()
  {
    ...
    databaseReference.child("car_details").set(onlineDriverData.walker_talk.toString() + " " + onlineDriverData.walker_pet.toString() + " " + onlineDriverData.walker_native.toString());
